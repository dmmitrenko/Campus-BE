...
namespace Campus.DataContext.Migrations
{
    ...
    [Migration("20221217115936_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.LessonNumber", b =>
                {
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.TeacherLessons", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.Schedule", b =>
                {
                    ...
                    b.HasOne("Campus.DataContext.Entities.LessonNumber", "Number")
                        .WithMany("Schedules")
                        .HasForeignKey("LessonNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Campus.DataContext.Entities.TeacherLessons", "TeacherLessons")
                        .WithOne("Schedule")
            ...
            modelBuilder.Entity("Campus.DataContext.Entities.TeacherLessons", b =>
                {
                    b.HasOne("Campus.DataContext.Entities.Lesson", "Lesson")
                        .WithMany("TeacherLessons")
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Campus.DataContext.Entities.Teacher", "Teacher")
                        .WithMany("TeacherLessons")
